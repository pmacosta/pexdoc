...
:py:func:`pexdoc.pcontracts.new_contract` and enforced via
:py:func:`pexdoc.pcontracts.contract` register exceptions using the
:py:mod:`pexdoc.exh` module, which means that the exceptions raised by these
contracts can be automatically documented using the :py:mod:`pexdoc.exdoc`
module.
...
:py:func:`pexdoc.ptypes.file_name` and
:py:func:`pexdoc.ptypes.file_name_exists` are:
...
1. To avoid repetition and errors, the exception messages defined in the
   :py:func:`pexdoc.pcontracts.new_contract` decorator are available in the
   contract definition function via :py:func:`pexdoc.pcontracts.get_exdesc`.
...
2. A `PyContracts new contract <http://andreacensi.github.io/contracts/
   ...
   contract specified via the :py:func:`pexdoc.pcontracts.new_contract`
...
having reasonable defaults (see :py:func:`pexdoc.pcontracts.new_contract` for a
...
.. autofunction:: pexdoc.pcontracts.all_disabled
.. autofunction:: pexdoc.pcontracts.disable_all
.. autofunction:: pexdoc.pcontracts.enable_all
.. autofunction:: pexdoc.pcontracts.get_exdesc

**********
Decorators
**********

.. function:: pexdoc.pcontracts.contract(\*\*contract_args)
    ...
    custom and specified with the :py:func:`pexdoc.pcontracts.new_contract`
    decorator. In this case the exception type and message are controlled
    by the custom contract specification.

.. function:: pexdoc.pcontracts.new_contract(\*args, \*\*kwargs)
    ...
    retrieved via the :py:func:`pexdoc.pcontracts.get_exdesc` function.
    ...
    new contract specified via the :py:func:`pexdoc.pcontracts.new_contract`
