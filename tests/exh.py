...
class TestExHandle(object):
    ...
    def test_add_exception(self):
        ...
        # Assertions
        exobj = pexdoc.exh.ExHandle(
            full_cname=True, exclude=['_pytest', 'tests.exh']
        )
        ...
        pexdoc.exh.set_exh_obj(
            pexdoc.exh.ExHandle(
                full_cname=True, exclude=['_pytest', 'eng']
            )
        )
        _ = eng.peng(15, 3, False)
        cdb = pexdoc.exh.get_exh_obj()._flatten_ex_dict()
    ...
    def test_add(self):
        ...
        def func1(exhobj, extra=False, rex=False):
            ...
            if extra:
                exhobj.add_exception(
                    'copy_exception_4', TypeError, 'Copy exception #4'
                )
        ...
        def func3(exhobj):
            ...
            pexdoc.exh.get_or_create_exh_obj(
                full_cname=True, exclude=exclude_list
            )
            eng.peng(1, 3, False)
