...
# pylint: disable=C0111,C0411,C0413,E0012,E0611,E1101,F0401,R0201,R0903,W0104
# pylint: disable=,W0212,W0403,W0612,W0613,W0621
...
# PyPI imports
import pmisc
from pmisc import AE, AI, AROPROP, CS, GET_EXMSG
import pytest
if sys.hexversion < 0x03000000:
    import mock
...
def exdocobj():
    ...
    with pexdoc.exdoc.ExDocCxt(_no_print=True, exclude=['_pytest']) as exdobj:
...
def exdocobj_single():
    ...
    if pexdoc.exh.get_exh_obj():
        pexdoc.exh.del_exh_obj()
    with pexdoc.exdoc.ExDocCxt(_no_print=True) as exdoc_single_obj:
...
def simple_exobj():
    ...
    exobj = pexdoc.exh.ExHandle(True)
    def func1():
        exobj.add_exception(
...
def trace_error_class():
    ...
    if pexdoc.exh.get_exh_obj():
        pexdoc.exh.del_exh_obj()
    pexdoc.exh.set_exh_obj(pexdoc.exh.ExHandle(True))
...
class TestExDocCxt(object):
    ...
    def test_init(self):
        ...
        def check_ctx1(name=None, kwargs=None):
            ...
            with pytest.raises(RuntimeError) as excinfo:
                with pexdoc.exdoc.ExDocCxt(**kwargs):
                    pmisc.pcolor('a', 'red')
        ...
        with pytest.raises(OSError) as excinfo:
            with pexdoc.exdoc.ExDocCxt(_no_print=True):
        ...
        with pmisc.TmpFile() as fname:
            with pexdoc.exdoc.ExDocCxt(pickle_fname=fname):
                func0()
        ...
        #
        with pytest.raises(OSError) as excinfo:
            with pexdoc.exdoc.ExDocCxt(in_callables_fname='_not_a_file_'):
                func0()
    ...
    def test_multiple(self):
        ...
        def test_trace():
            cobj = pexdoc.exdoc.ExDocCxt
            with cobj(_no_print=True, exclude=['_pytest']) as tobj:
                tests.support.exdoc_support_module_4.func('John')
                obj1 = copy.copy(pexdoc.exh.get_exh_obj())
                pexdoc.exh.del_exh_obj()
                pexdoc.exh.get_or_create_exh_obj(
                    full_cname=True, exclude=['_pytest']
                )
                func1()
                obj2 = copy.copy(pexdoc.exh.get_exh_obj())
        ...
        from tests.support.eng import peng
        pexdoc.exh.get_or_create_exh_obj()
        peng(3.125, 1)
        prev_exhobj = copy.copy(pexdoc.exh.get_exh_obj())
        test_trace()
        assert prev_exhobj == pexdoc.exh.get_exh_obj()
...
class TestExDoc(object):
    ...
    def test_init(self, simple_exobj):
        ...
        args = {'exh_obj':pexdoc.exh.ExHandle(True), '_no_print':False}
        AE(obj, ValueError, exmsg, **args)
        AI(obj, '_no_print', exh_obj=simple_exobj, _no_print=5)
        pexdoc.exdoc.ExDoc(simple_exobj, depth=1, exclude=[])

    def test_copy(self, exdocobj):
        """ Test __copy__ method behavior """
        prev_exobj = copy.copy(pexdoc.exh.get_exh_obj())
        ...
        assert prev_exobj == pexdoc.exh.get_exh_obj()
    ...
    def test_build_ex_tree(self, exdocobj):
        ...
        exobj1 = pexdoc.exh.ExHandle(full_cname=True)
        def func1():
        ...
        ref = (
            'tests.exdoc.exdocobj\n'
            '├tests.exdoc.exdocobj.multi_level_write\n'
            '│└mod.write (*)\n'
            '│ └mod._write\n'
            '│  └mod._validate_arguments (*)\n'
            '├mod.ExceptionAutoDocClass.__init__ (*)\n'
            '│├tests.support.trie.add_nodes (*)\n'
            '│└tests.support.trie.create_trie (*)\n'
        ...
        exdocobj = pexdoc.exdoc.ExDoc(exobj, _no_print=True, _empty=True)
        ...
        pmisc.compare_strings(str(exdocobj._tobj), ref)

    def test_depth(self, simple_exobj):
        """ Test depth property behavior """
        obj = pexdoc.exdoc.ExDoc(simple_exobj, _no_print=True)
    ...
    def test_get_sphinx_autodoc(self, exdocobj, exdocobj_single):
        ...
        sfunc = 'pexdoc.exdoc.sys._getframe'
    ...
    def test_get_sphinx_doc(self, exdocobj, exdocobj_raised):
        ...
        minwidth = pexdoc.exdoc._MINWIDTH
        ...
        pexdoc.exdoc._MINWIDTH = minwidth
        CS(obj(root+'write'),
            '.. Auto-generated exceptions documentation for\n'
            '.. tests.support.exdoc_support_module_1.write'
        ...
        exclude_list = ['tests.support.trie']
        CS(obj(root+'ExceptionAutoDocClass.__init__', exclude=exclude_list),
            '.. Auto-generated exceptions documentation for\n'
            '.. tests.support.exdoc_support_module_1.ExceptionAutoDocClass.'
            '__init__\n\n'
            ':raises:\n'
        ...
        tstr = obj(
            ...
            exclude=['tests.support.trie.add_nodes']
        )
        CS(tstr,
            '.. Auto-generated exceptions documentation for\n'
            '.. tests.support.exdoc_support_module_1.ExceptionAutoDocClass.'
